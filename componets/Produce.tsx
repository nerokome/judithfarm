...
const collections = [
  {
    id: 1,
    title: "Organic Root Crops",
    subtitle: "Potatoes, Carrots & Tubers",
    img: "/potatoes.jpg", // Replace with your actual image path
    accent: "bg-amber-500/10 text-amber-700",
  },
  {
    id: 2,
    title: "Sustainable Fisheries",
    subtitle: "Freshwater Trout & Tilapia",
    img: "/fish.jpg", 
  ...
  },
  {
    id: 3,
    title: "Leafy Harvest",
    subtitle: "Spinach, Kale & Bok Choy",
    img: "/greens.jpg",
    accent: "bg-emerald-500/10 text-emerald-700",
  },
  {
    id: 4,
    title: "Field Orchards",
    subtitle: "Seasonal Fruits & Berries",
    img: "/fruits.jpg",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-2xl mb-16">
          ...
          <h3 className="text-5xl md:text-6xl font-serif text-stone-800 leading-tight">
            The bounty of our <br />
            <span className="italic text-[#2D5A27]">diverse landscape.</span>
          </h3>
        </div>
          ...
          {collections.map((item, idx) => (
            ...
            >
              ...
              <div className="relative aspect-[16/10] md:aspect-[16/9] rounded-[2.5rem] overflow-hidden mb-6 shadow-sm group-hover:shadow-2xl transition-all duration-700 border border-stone-100">
                ...
                {/* View Details Label (Bottom Right) */}
              ...
              <div className="flex justify-between items-start px-2">
                <div>
                  <div className={`inline-block px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider mb-3 ${item.accent}`}>
                    Harvesting Now
                  </div>
        ...
        <div className="mt-20 border-t border-stone-100 pt-12 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          <p className="text-stone-500 font-light max-w-sm">
            Interested in wholesale or bulk orders for your local business? 
